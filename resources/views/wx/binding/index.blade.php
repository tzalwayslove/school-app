...
<div class="input-in">
    学号<input type="text" class="bind-input-style" placeholder="点此输入学号" id="account"/>
</div>
<div class="input-in">
    密码<input type="password" class="bind-input-style" placeholder="点此输入教务处密码" id="password"/>
</div>
