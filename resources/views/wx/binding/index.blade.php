...
<div style="margin:30px 15% 10px;">
    <button style="width: 100%; text-align:center;border: 1px solid #FFFFFF;border-radius: 30px;margin: 0;background: #FFF;font-weight:bold;color: #3CC3B6;font-size: 16px;
	padding:10px 12px;" id="binding" >绑&nbsp; 定</button>
