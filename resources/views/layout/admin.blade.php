                    ...
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            ...
                            <li><a><i class="fa fa-edit"></i> 文章管理 <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="{{ url('admin/posts') }}">文章列表</a></li>
                                    <li><a href="{{ url('admin/posts/create') }}">添加新文章</a></li>
                                    <li><a href="{{ url('admin/category') }}">所有分类</a></li>
                                    <li><a href="{{ url('admin/category/create') }}">添加新分类</a></li>
                                </ul>
                            </li>
