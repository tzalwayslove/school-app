                ...
                <div class="x_panel">
                    <div class="x_content">
                        <form class="form-horizontal form-label-left" novalidate data-parsley-validate
                              action="{{ url('admin/log') }}" method="post">
                            {{ csrf_field() }}
                            <span class="section">Log信息</span>

                                                                                                                                ;
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="data">数据</label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input id="data" class="form-control col-md-7 col-xs-12" name="data" placeholder="请输入数据" required="required" value="" type="text">
                                    </div>
                                </div>
