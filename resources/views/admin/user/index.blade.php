                            ...
                            <div class="col-sm-12">
                                <table id="datatable" class="table table-striped table-bordered dataTable no-footer"
                                    ...
                                    <tr>
                                                                                                                                    <th width="35px">id</th>
                                                                                                                                                                                <th width="35px">账户</th>
                                                                                                                                                                                                                                                                                                                                                        <th width="35px">微信昵称</th>
                                                                                                                                                                                <th width="35px">用户头像</th>
                                                                                                                                                                                <th width="35px">性别</th>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                            <th width="75px">操作</th>
                                    </tr>
                                    </thead>
                                    ...
                                    <tr>
                                                                                                                                    <td>{{ $v->id }}</td>
                                                                                                                                                                                <td>{{ $v->account }}</td>
                                                                                                                                                                                                                                                                                                                                                        <td>{{ $v->wx_name }}</td>
                                                                                                                                                                                <td><div style="max-height: 100px;max-width: 100px;"><img src="{{ asset(is_null($v->wx_img) ? 'public/images/default.png':('storage/app/'.$v->wx_img )) }}"  alt="" class="img-responsive" style="max-height: 50px;"></div></td>
                                                                                                                                                                                <td>{{ $v->sex }}</td>
